...
const APP_NAME = 'Athleo';
const APP_SLUG = 'athleomobile';
const ANDROID_PROD_BUNDLE_IDENTIFIER = 'com.SparkyApps.AthleoMobile';
const IOS_PROD_BUNDLE_IDENTIFIER = 'com.SparkyApps.AthleoMobile';
const DEV_BUNDLE_IDENTIFIER = process.env.EXPO_DEV_BUNDLE_IDENTIFIER || 'org.SparkyApps.AthleoMobile.dev';
