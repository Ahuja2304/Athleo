...
const HealthDataSync: React.FC<HealthDataSyncProps> = ({
  ...
  const platformDetail = isIOS
    ? 'Athleo reads the health data you select below using Apple Health (HealthKit). If sync is enabled, data is synchronized only between your device and your self-hosted Athleo server (manual or background).\n\nManage or remove access in Settings → Health → Data Access & Devices → AthleoMobile'
    : 'Athleo reads the health data you select below using Health Connect. If sync is enabled, data is synchronized only between your device and your self-hosted Athleo server (manual or background).';
