            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="adaptive-goal" className="cursor-pointer">
                ...
                {t(
                  ...
                  "The 'Gold Standard'. Athleo calculates your TDEE by correlating your actual weight changes with your calorie intake over the last 35 days. It 'learns' your unique metabolism."
                )}
              </Label>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="tdee-goal" className="cursor-pointer">
                ...
                {t(
                  ...
                  'Like MyFitnessPal with Apple Watch. Athleo projects your full-day burn by extrapolating your current device data to midnight. The adjustment = projection − TDEE.'
                )}
              </Label>
            </div>
