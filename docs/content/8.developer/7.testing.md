...
Athleo uses **Jest** for JavaScript/TypeScript testing across the frontend, backend, and mobile projects, and **pytest** for the Garmin microservice.
...
|-----------|-------------|-----------------|--------------|
| Frontend  | `AthleoFrontend/**` | pnpm | `pnpm run test:ci` |
| Mobile    | `AthleoMobile/**` | npm | `npm run test:ci` |
| Server    | `AthleoServer/**` | pnpm | `pnpm run test:ci` |
| Garmin    | `AthleoGarmin/**` | pip | `pytest` |
