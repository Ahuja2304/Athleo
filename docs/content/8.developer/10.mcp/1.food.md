...
The `manage_food` tool is the primary interface for all nutrition tracking and management within Athleo. It allows users and AI agents to search for food, log meals, create custom food items, and manage their daily food diary.
