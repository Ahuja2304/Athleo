...
This page explains how to manage preference settings in **Athleo**.
...
> It is a Athleo feature that allows users to change serving sizes while automatically adjusting nutrition values.
