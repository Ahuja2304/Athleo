...
The Polar integration allows you to sync workouts, physical measurements, and daily activity metrics from your Polar account directly to Athleo.
...
2.  **Configure Callback URL**: In the Polar Admin portal, set your **Callback URL** to:
    Directly get from External Providers page in Athleo    
3.  **Enter Credentials**: In Athleo Settings, navigate to **External Providers** and add a new "Polar" provider.
4.  **Enter Client ID and Client Secret**: Copy these from your Polar Admin dashboard into the Athleo form.
5.  **Authorize**: Click "Connect" and you will be redirected to Polar to authorize the connection.

## Data Synchronized

Athleo pulls the following data from Polar:
...
> *   **No Historical Backfill**: Polar only allows access to data uploaded **after** you have authorized the Athleo integration. Workouts recorded before you linked your account will not sync.
