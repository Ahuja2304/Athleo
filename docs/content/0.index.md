...
Welcome to the comprehensive documentation for **Athleo**, a self-hosted alternative to MyFitnessPal with AI-powered nutrition assistance.

:::info
**Disclaimer**: While we strive to keep this documentation as accurate and up-to-date as possible, some sections may occasionally become outdated. If you encounter any issues or have questions, please reach out via our [GitHub Discussions](https://github.com/Ahuja2304/Athleo/discussions) or join our [Discord community](https://discord.gg/vcnMT5cPEA) where others can help you.
:::

## What is Athleo?

Athleo is a full-stack fitness tracking application that helps you monitor nutrition, exercise, body measurements, and achieve your health goals. Built with modern web technologies and designed for self-hosting, it provides complete control over your fitness data.
...
Athleo is open source software. Please check the repository for license details.