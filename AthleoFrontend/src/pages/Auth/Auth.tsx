    ...
    const fetchAuthSettings = async () => {
      ...
      try {
        if (
          ...
          // AUTO-REDIRECT LOGIC: Only when email is disabled, auto_redirect is enabled (e.g. ATHLEO_OIDC_AUTO_REDIRECT), and exactly 1 OIDC provider is active
          if (
