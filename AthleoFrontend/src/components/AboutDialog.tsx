  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent ref={contentRef}>
        <AlertDialogHeader>
          <AlertDialogTitle>
            {t('aboutDialog.title', 'About Athleo')}
          </AlertDialogTitle>
          <AlertDialogDescription>
            <div className="space-y-4">
              <p>
                {t(
                  ...
                  'Athleo: Built for Families. Powered by AI. Track food, fitness, water, and health — together.'
                )}
              </p>
              <p>
              ...
              <div>
                ...
                <a
                  href="https://github.com/Ahuja2304/Athleo"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-500 hover:underline"
                >
