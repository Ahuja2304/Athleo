...
GARMIN_DATA_SOURCE = os.getenv("ATHLEO_GARMIN_DATA_SOURCE", "garmin").lower() # "garmin" or "local"
SAVE_MOCK_DATA = os.getenv("ATHLEO_SAVE_MOCK_DATA", "false").lower() == "true"
...
def map_garmin_stress_to_mood(stress_level):
    """
    Maps Garmin stress level (0-100) to Athleo mood value (0-100).
...
async def garmin_resume_login(request: Request):
    ...
    try:
        ...
        user_id = data.get("user_id")  # Athleo user ID
