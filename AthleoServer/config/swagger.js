...
const options = {
  ...
  apis: ['./routes/*.js', './routes/auth/*.js', './models/*.js', './AthleoServer.js'], // Paths to files containing OpenAPI definitions
};
