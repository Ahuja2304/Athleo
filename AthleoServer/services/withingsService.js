// AthleoServer/services/withingsService.js
...
const WITHINGS_DATA_SOURCE =
  process.env.ATHLEO_WITHINGS_DATA_SOURCE || "withings";
log(
  "info",
...
async function syncWithingsData(userId, syncType = "manual") {
  ...
  if (WITHINGS_DATA_SOURCE === "local") {
    ...
    if (!bundle || !bundle.responses) {
      throw new Error(
        'Raw diagnostic bundle not found. Please run a sync with ATHLEO_WITHINGS_DATA_SOURCE unset (or set to "withings") ' +
