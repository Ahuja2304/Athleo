// AthleoServer/services/fitbitService.js
...
const FITBIT_DATA_SOURCE =
  process.env.ATHLEO_FITBIT_DATA_SOURCE || "fitbit";
log(
  "info",
...
async function syncFitbitData(
  ...
  if (FITBIT_DATA_SOURCE === "local") {
    ...
    if (!bundle || !bundle.responses) {
      throw new Error(
        'Raw diagnostic bundle not found. Please run a sync with ATHLEO_FITBIT_DATA_SOURCE unset (or set to "fitbit") ' +
