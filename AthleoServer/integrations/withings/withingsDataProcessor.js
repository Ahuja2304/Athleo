// AthleoServer/integrations/withings/withingsDataProcessor.js
...
// Define a mapping for Withings metric types to Athleo measurement types
...
async function processWithingsSleepData(
  ...
  // Map Withings sleep states to Athleo stage types
...
async function processWithingsWorkouts(userId, createdByUserId, workouts = []) {
    ...
    // Define a mapping for Withings workout categories to Athleo exercise names
