// AthleoServer/integrations/hevy/hevyService.js
...
const HEVY_DATA_SOURCE = process.env.ATHLEO_HEVY_DATA_SOURCE || "hevy";
log(
  "info",
 ...
 * @param {string} userId - The Athleo user ID.
...
async function syncHevyData(
  ...
  if (HEVY_DATA_SOURCE === "local") {
    ...
    if (!bundle || !bundle.responses) {
      throw new Error(
        'Raw diagnostic bundle not found. Please run a sync with ATHLEO_HEVY_DATA_SOURCE unset (or set to "hevy") ' +
