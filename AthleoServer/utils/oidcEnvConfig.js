 ...
 * When ATHLEO_OIDC_ISSUER_URL, CLIENT_ID, CLIENT_SECRET, and PROVIDER_SLUG are set,
...
const ENV_ISSUER = 'ATHLEO_OIDC_ISSUER_URL';
const ENV_CLIENT_ID = 'ATHLEO_OIDC_CLIENT_ID';
const ENV_CLIENT_SECRET = 'ATHLEO_OIDC_CLIENT_SECRET';
const ENV_PROVIDER_SLUG = 'ATHLEO_OIDC_PROVIDER_SLUG';
const ENV_PROVIDER_NAME = 'ATHLEO_OIDC_PROVIDER_NAME';
const ENV_SCOPE = 'ATHLEO_OIDC_SCOPE';
const ENV_AUTO_REGISTER = 'ATHLEO_OIDC_AUTO_REGISTER';
const ENV_LOGO_URL = 'ATHLEO_OIDC_LOGO_URL';
const ENV_DOMAIN = 'ATHLEO_OIDC_DOMAIN';
const ENV_TOKEN_AUTH_METHOD = 'ATHLEO_OIDC_TOKEN_AUTH_METHOD';
const ENV_ID_TOKEN_SIGNED_ALG = 'ATHLEO_OIDC_ID_TOKEN_SIGNED_ALG';
const ENV_USERINFO_SIGNED_ALG = 'ATHLEO_OIDC_USERINFO_SIGNED_ALG';
const ENV_TIMEOUT = 'ATHLEO_OIDC_TIMEOUT';
const ENV_ADMIN_GROUP = 'ATHLEO_OIDC_ADMIN_GROUP';
